...
namespace traaittCASH;

use traaittCASH\Http\JsonResponse;
use traaittCASH\Http\RpcClient;

/**
 * Wrapper for traaittCASH's XTCASHnetwork JSON-RPC interface.
 * @package traaittCASH
 */
class XTCASHnetwork extends RpcClient
{
    /** @var int */
    protected $rpcPort = 24496;
     ...
     * @param string $address     Valid traaittCASH wallet address. Required.
     * @return JsonResponse
     */
